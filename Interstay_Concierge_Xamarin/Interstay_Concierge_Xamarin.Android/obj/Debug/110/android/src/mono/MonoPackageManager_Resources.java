...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Interstay_Concierge_Xamarin.Android.dll" comes first in this list. */
		"Interstay_Concierge_Xamarin.Android.dll",
		"FormsViewGroup.dll",
		"Interstay_Concierge_Xamarin.dll",
